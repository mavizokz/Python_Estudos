#Faça o computador  "pensar" em um número entre 0 e 10.
#E o jogador vai tentar adivinhar até acertar, mostrando no final quantos palpites foram necessários para vencer
